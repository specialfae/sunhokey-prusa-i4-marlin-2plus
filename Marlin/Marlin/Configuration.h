...
#define STRING_CONFIG_H_AUTHOR "GMACK" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "lilmoppy"
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.4, 400*1.010, 90 } //stock sunhokey 1.1 values -always iffy but worked with 1.1
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.4, 400*1.010, 99 } //http://aeinc.ru/i4/ 1.1.8 values -less flow compensation needed, never ran 1.1.8 myself
#define DEFAULT_AXIS_STEPS_PER_UNIT { 80.4, 80.4, 400*1.020, 99 } //my new 2.1.1 values from ametur calibration
